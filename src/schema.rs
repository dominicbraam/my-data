...
pub mod financial {
    diesel::table! {
        financial.bank_account_balance_history (id) {
            id -> Int4,
            account_id -> Int4,
            balance -> Numeric,
            created_at -> Timestamp,
    ...
    diesel::table! {
        financial.bank_account_types (id) {
            id -> Int4,
            #[sql_name = "type"]
            type_ -> Varchar,
        }
    ...
    diesel::table! {
        financial.transaction_actions (id) {
            id -> Int4,
            actions -> Varchar,
    ...
    diesel::table! {
        financial.transaction_groups (id) {
            id -> Int4,
            description -> Text,
            created_at -> Timestamp,
            updated_at -> Nullable<Timestamp>,
    ...
    diesel::table! {
        financial.transaction_products (id) {
            id -> Int4,
            record_group -> Int4,
            is_current -> Bool,
            name -> Varchar,
    ...
    diesel::table! {
        financial.transaction_types (id) {
            id -> Int4,
            #[sql_name = "type"]
            type_ -> Varchar,
        }
